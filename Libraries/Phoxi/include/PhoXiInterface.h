...
class PHOXI_DLL_API PhoXiInterface {
  public:
    ...
    */
    ...
    Settings like TriggerMode(Software or Freerun) can be changed only when the device is not in acquisition mode
    @return true if the device is connected ans is in acquisition mode
    */
    virtual bool isAcquiring();
    ///Set user specified name for the device handle
    /**
    Set the local name for the device handle
    This can be used for easier description of the device in user code
    This setting is local, and does not affect the device or PhoXiControl in any way
    @param Name New name for the device
    */
    void SetName(const std::string &Name);
    ///Get user specified name for the device handle
    /**
    Get the local name for the device handle
    This can be used for easier description of the device in user code
    This setting is local, and does not affect the device or PhoXiControl in any way
    ...
    */
    ...
    If the Frame fails, the nonempty structure will be returned. Frame->Successful defines if the Captured frame was successfuly captured
    ...
    */
    ...
    If the Frame with the specific FrameID is already in the buffer, the call of this function with zero timeout will return the Frame
    If the Timeout pass, the call returns with empty PFrame equal to std::nullptr
    If the Frame fails, the nonempty structure will be returned. Frame->Successful defines if the Captured frame was successfuly captured
    @param Timeout - Timeout in ms, or PhoXiTimeout::ZeroTimeout, PhoXiTimeout::Infinity, PhoXiTimeout::LastStored. Default is PhoXiTimeout::LastStored - Can be specified by setting Timeout feature
    @return nonempty PFrame on success, nullptr otherwise
    ...
    */
    ...
    @param FilePath - Path where the file should be saved. Absolute path is preferred (e.g. C:/Users/Public/*.praw, /home/user/*praw), relative path points to PhoXiControl's path
